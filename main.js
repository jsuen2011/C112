...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/6E1OsZtCR/model.jason',modelLoaded);
...
function check(){
img=document.getElementById('captured_imnage');
